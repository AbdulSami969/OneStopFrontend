...
export default function Hero({ data }: HeroProps = {}) {
  ...
  return (
    <section className="relative bg-cover bg-center min-h-[500px] md:min-h-[600px] h-[calc(100vh-55px)] md:h-auto  flex flex-col justify-center" style={{ backgroundImage: `url('${backgroundImage}')` }}>
