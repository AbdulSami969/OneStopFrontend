   ...
   <div className="fixed bottom-0 right-2 z-50 hidden md:flex items-center rtl:space-x-reverse">
        <div className="bg-pest-red rounded-t-lg shadow-lg overflow-hidden flex items-center">
          <div className="flex divide-x divide-red-700">
            ...
            >
               <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 509 511.514">
            ...
            >
              ...
              <span className="pt-1">AI Chat</span>
            </button>
          </div>
        </div>
      </div>
